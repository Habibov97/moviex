...
import { DISCOVER_HREF, movieHref } from "@/lib/constants/discover";
 ...
 */
export async function SearchEmptyState({ suggestions }: SearchEmptyStateProps) {
  ...
  return (
    <div className="flex flex-col items-center px-4 py-16 text-center font-mx sm:px-6">
      ...
      {suggestions.length > 0 && (
        <div className="mt-10">
          <p className="text-[12px] text-mx-fg-faint">{t("popularRightNow")}</p>
